  ...
  <div>
     ...
     <!-- .TODO: 卡片区域 -->
      <el-card class="box-card">
           ...
           <el-steps :space="200" :active="+activeName" finish-status="success" align-center>
             <el-step title="基本信息">
   ...
   <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position='top'>
     ...
     <el-tabs :tab-position="tabPosition='left'" v-model="activeName"  @tab-click = 'handleChange'  :before-leave ='beforeLeave'>
       ...
       <el-tab-pane label="基本信息" name="0">      
         ...
         <el-form-item label="商品名称" prop="goods_name">
            ...
            <el-form-item v-for="(item,i) in manyData" :key="i" :label="item.attr_name">
               ...
               <!-- 双向绑定  attr_vals 数组,只要点击复选框 attr_vals 数组也会同步变化 -->
                <el-checkbox-group v-model="item.attr_vals">
                  ...
                  <!-- 遍历 动态参数 -->
                  <el-checkbox v-for="(item1,i) in item.attr_vals" :key="i" :label="item1">
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <!-- 添加按钮 -->
            <el-button type="primary" class='addIt' @click="postFormData">添加商品</el-button>
        ...
        //.TODO: tabs 跳转
          beforeLeave(newVal,oldVal) {
            ...
            // oldVal 表示从哪里跳转的旧的tab页
              ...
              if(newVal === '1' && oldVal === '0' &&  this.addForm.goods_cat.length != 3) {
                // 提示选中 商品分类
         ...
         handleRemove(file){
          ...
          const i = this.addForm.pics.findIndex(item => item.pic === file.response.data.tem_path)
