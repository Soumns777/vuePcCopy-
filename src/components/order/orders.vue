     ...
     <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-card class="box-card">
          ...
          <el-row :gutter="15">
             ...
             <el-col :span="8"><el-input clearable v-model="queryInfo.query" @clear='getOrdersList' ><el-button slot="append" icon="el-icon-search" @click='getOrdersList' ></el-button></el-input></el-col>
          ...
          <!-- .FIXME: 表格区域 -->
            <el-table :data="orderList"  stripe border style="width: 100%">
               ...
               <el-table-column label="是否付款" > 
                 ...
                 <el-button type="danger" size="mini" v-if="scoped.row.pay_status == 0">未付款</el-button>
               ...
               <el-table-column label="操作">
                   <!-- 利用作用域插槽 渲染按钮 -->
                    <template v-slot='scoped'>
                        ...
                        <el-button type="primary" size="mini" class="el-icon-setting" @click='editOrdersgVisible = true'>编辑</el-button>

                        <el-button type="success" size="mini" class="el-icon-location" @click='showInfo'>定位</el-button>
            ...
            <!-- .FIXME: 编辑对话框 -->
            <el-dialog title="编辑订单" :visible.sync="editOrdersgVisible" width="50%"
              ...
              <el-form ref="editOrdersRef" :model="editForm" :rules="editOrderRules">
               ...
               <el-form-item label="请输入详细地址" prop="addressInfo">
                ...
                <span slot="footer" class="dialog-footer">
                  <el-button @click="editOrdersgVisible = false" type="warning">取 消</el-button>
                  <el-button type="primary" @click="editOrdersgVisible = false">确 定</el-button>
              </span>
       ...
       <span slot="footer" class="dialog-footer">
                  <el-button @click="lookVisible = false" type="warning">取 消</el-button>
